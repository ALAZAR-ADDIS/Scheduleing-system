...
type NotifType = "appointment" | "booking" | "status";
...
const INITIAL: Notif[] = [
  { id: 1, type: "appointment", text: "Your appointment with",   bold: "Sarah Johnson",  time: "2 hours ago",    read: false },
  { id: 2, type: "booking",     text: "New booking confirmed with", bold: "Michael Chen", time: "Yesterday",      read: false },
  { id: 3, type: "status",      text: "Appointment status changed to", bold: "Completed", time: "2 days ago",     read: true  },
];
